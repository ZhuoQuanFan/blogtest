      ...
      <main className='flex max-h-[90svh] max-w-prose flex-1 flex-col overflow-hidden rounded-2xl border border-gray-600 shadow-2xl shadow-black'>
        ...
        <div className='min-h-60 flex-1 overflow-y-auto p-2 text-sm text-gray-200 duration-300 animate-in fade-in'>
          ...
          <Typed>
            ...
            <TypedContent>
              <p>
                Hi, I&apos;m <strong>Fan Zhuoquan</strong>, in Chinese my name is{' '}
                <strong>范倬铨</strong>. You can call me Jason.
              </p>
              <p>
                I am a postgraduate student who majors in Computer Science in SYSU.I have devoted myself in coding and learning
                different kinds of languages and structures.
              </p>
            </TypedContent>
